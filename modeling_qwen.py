...
# transformers_stream_generator is optional - only needed for streaming
try:
...
class QWenModel(QWenPreTrainedModel):
    ...
    def forward(
        ...
        if past_key_values is None:
            ...
            # Handle case where past_key_values[0][0] might be None
...
class QWenLMHeadModel(QWenPreTrainedModel):
    ...
    def chat_stream(
        ...
        try:
            ...
            raise ImportError("Streaming generation requires transformers_stream_generator. For non-streaming text-only inference, use the regular chat() method instead.")
